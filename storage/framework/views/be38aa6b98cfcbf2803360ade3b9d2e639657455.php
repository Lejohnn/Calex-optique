<?php $__env->startSection('title', 'Interactions de Service Call'); ?>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">Interactions de Service Call pour <?php echo e($client->nom); ?> <?php echo e($client->prenom); ?></h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a href="<?php echo e(route('call.entreprise.create', $client->id)); ?>" class="btn btn-primary">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($interaction->formatted_date); ?></td>
                                                
                                                <td>
                                                    <a href="<?php echo e(route('call.entreprise.edit', [$client->id, $interaction->id])); ?>"><i class="ft-edit text-success"></i></a>
                                                    <a href="<?php echo e(route('call.entreprise.show', [$client->id, $interaction->id])); ?>"><i class="ft-eye text-info"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\line\Calex_op\Calex-optique\resources\views/call/entreprise/index.blade.php ENDPATH**/ ?>