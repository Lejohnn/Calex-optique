<?php $__env->startSection('content'); ?>
   ...
   <section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="true" data-autoplay="4859" data-simulate-touch="true" data-direction="vertical" data-nav="false">
    <div class="swiper-wrapper text-center">
      <div class="swiper-slide" data-slide-bg="<?php echo e(asset('frontend/images/8.jpg')); ?>">
      ...
      <div class="swiper-slide" data-slide-bg="<?php echo e(asset('frontend/images/IMG.jpg')); ?>">
        <div class="swiper-slide-caption section-md">
          <div class="container">
            <h1 data-caption-animate="fadeInLeft" data-caption-delay="0"></h1>
            <a class="button button-primary button-ujarak" href="#modalCta" data-toggle="modal" data-caption-animate="fadeInUp" data-caption-delay="200">Get in touch</a><p class="text-width-large" data-caption-animate="fadeInRight" data-caption-delay="100">We are a team of qualified software developers, aimed at creating unique and powerful tools for your business & everyday life.</p>
          </div>
        </div>
      </div>
      <div class="swiper-slide" data-slide-bg="<?php echo e(asset('frontend/images/3.jpg')); ?>">
        <div class="swiper-slide-caption section-md">
          <div class="container">
...
<section class="section section-sm section-first bg-default text-center" id="services">
  <div class="container">
    <div class="row row-30 justify-content-center">
      <div class="col-md-7 col-lg-5 col-xl-6 text-lg-left wow fadeInUp"><img src="<?php echo e(asset('frontend/images/index-1-415x592.png')); ?>" alt="" width="415" height="592"/>
      </div>
        ...
        <div class="row row-30">
          ...
          <div class="col-sm-6 wow fadeInRight" data-wow-delay=".1s">
            <article class="box-icon-modern box-icon-modern-2">
              <div class="box-icon-modern-icon "><img src="<?php echo e(asset('frontend/images/contact-lens.jpg')); ?>" alt="" width="415" height="592"/></div>
              <h5 class="box-icon-modern-title"><a href="#">CONSULTATION DES <br>YEUX</a></h5>
              <div class="box-icon-modern-decor"></div>
              <p class="box-icon-modern-text">Des consultations personnalisées pour évaluer et préserver la santé de vos yeux.</p>
            </article>
          </div>
          <div class="col-sm-6 wow fadeInRight" data-wow-delay=".2s">
            <article class="box-icon-modern box-icon-modern-2">
              <div class="box-icon-modern-icon"><img src="<?php echo e(asset('frontend/images/doctor.jpg')); ?>" alt="" width="415" height="592"/></div>
              <h5 class="box-icon-modern-title"><a href="#">VENTE DE <br>LUNETTES</a></h5>
              <div class="box-icon-modern-decor"></div>
              <p class="box-icon-modern-text">Une sélection soigneusement choisie de lunettes pour répondre à vos besoins de vision et de style.</p>
            </article>
          </div>
          <div class="col-sm-6 wow fadeInRight" data-wow-delay=".3s">
            <article class="box-icon-modern box-icon-modern-2">
              <div class="box-icon-modern-icon "><img src="<?php echo e(asset('frontend/images/lunettes.jpg')); ?>" alt="" width="415" height="592"/></div>
              <h5 class="box-icon-modern-title"><a href="#">CONSEILS <br>OPTIQUES</a></h5>
              <div class="box-icon-modern-decor"></div>
              <p class="box-icon-modern-text">Des conseils experts pour vous aider à prendre les meilleures décisions pour votre santé visuelle.</p>
            </article>
          </div>
        </div>
      </div>
...
<section class="section section-fluid bg-default">
  <div class="parallax-container" data-parallax-img="<?php echo e(asset('frontend/images/parallax-1.jpg')); ?>">
    ...
    <div class="row row-30 isotope" data-isotope-layout="fitRows" data-isotope-group="gallery" data-lightgallery="group">
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInRight" data-filter="Type 4">
        ...
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-1-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-1-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-1-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInRight" data-filter="Type 1" data-wow-delay=".1s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-2-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-2-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-2-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInRight" data-filter="Type 2" data-wow-delay=".2s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-3-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-3-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-3-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInRight" data-filter="Type 3" data-wow-delay=".3s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-4-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-4-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-4-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInLeft" data-filter="Type 3">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-5-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-5-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-5-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInLeft" data-filter="Type 1" data-wow-delay=".1s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-6-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-6-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-6-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInLeft" data-filter="Type 2" data-wow-delay=".2s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-7-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-7-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-7-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
      ...
      <div class="col-sm-6 col-lg-4 col-xxl-3 isotope-item wow fadeInLeft" data-filter="Type 3" data-wow-delay=".3s">
        <!-- Thumbnail Classic-->
        <article class="thumbnail thumbnail-classic thumbnail-md">
          <div class="thumbnail-classic-figure"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-8-420x350.jpg')); ?>" alt="" width="420" height="350"/>
          </div>
          <div class="thumbnail-classic-caption">
            <div class="thumbnail-classic-title-wrap"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('frontend/images/grid-gallery-8-1200x800-original.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('frontend/images/fullwidth-gallery-8-420x350.jpg')); ?>" alt="" width="420" height="350"/></a>
  ...
  <div class="container">
    <div class="row row-30 row-xl-24 justify-content-center align-items-center align-items-lg-start text-left">
      <div class="col-md-6 col-lg-5 col-xl-4 text-center"><a class="text-img" href="#">
          <div id="particles-js"></div><span class="counter">18</span></a></div>
      ...
      <div class="col-lg-6 col-xl-12 align-self-center">
        <div class="row row-30 justify-content-center">
          <div class="col-sm-6 col-md-5 col-lg-6 col-xl-3 wow fadeInLeft"><a class="clients-classic" href="#"><img src="<?php echo e(asset('frontend/images/clients-9-270x117.png')); ?>" alt="" width="270" height="117"/></a></div>
          <div class="col-sm-6 col-md-5 col-lg-6 col-xl-3 wow fadeInLeft" data-wow-delay=".1s"><a class="clients-classic" href="#"><img src="<?php echo e(asset('frontend/images/clients-10-270x117.png')); ?>" alt="" width="270" height="117"/></a></div>
          <div class="col-sm-6 col-md-5 col-lg-6 col-xl-3 wow fadeInLeft" data-wow-delay=".2s"><a class="clients-classic" href="#"><img src="<?php echo e(asset('frontend/images/clients-3-270x117.png')); ?>" alt="" width="270" height="117"/></a></div>
          <div class="col-sm-6 col-md-5 col-lg-6 col-xl-3 wow fadeInLeft" data-wow-delay=".3s"><a class="clients-classic" href="#"><img src="<?php echo e(asset('frontend/images/clients-11-270x117.png')); ?>" alt="" width="270" height="117"/></a></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row row-sm row-30 justify-content-center">
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight">
        <!-- Team Classic-->
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="<?php echo e(asset('frontend/images/team-11-420x424.jpg')); ?>" alt="" width="420" height="424"/></a>
      ...
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".1s">
        <!-- Team Classic-->
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="<?php echo e(asset('frontend/images/team-12-420x424.jpg')); ?>" alt="" width="420" height="424"/></a>
          <div class="team-classic-caption">
      ...
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".2s">
        <!-- Team Classic-->
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="<?php echo e(asset('frontend/images/team-13-420x424.jpg')); ?>" alt="" width="420" height="424"/></a>
          <div class="team-classic-caption">
      ...
      <div class="col-md-6 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay=".3s">
        <!-- Team Classic-->
        <article class="team-classic team-classic-lg"><a class="team-classic-figure" href="#"><img src="<?php echo e(asset('frontend/images/team-14-420x424.jpg')); ?>" alt="" width="420" height="424"/></a>
          <div class="team-classic-caption">
  ...
  <div class="container">
    <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
      ...
      <div class="col-lg-6 text-center wow fadeInUp" data-wow-delay=".1s">
        <div class="owl-carousel owl-style-1" data-items="2" data-stage-padding="0" data-loop="true" data-margin="0" data-mouse-drag="true" data-autoplay="true"><a class="box-device" href="#"><img src="<?php echo e(asset('frontend/images/index-4-313x580.png')); ?>" alt="" width="313" height="580"/></a><a class="box-device" href="#"><img src="<?php echo e(asset('frontend/images/index-5-313x580.png')); ?>" alt="" width="313" height="580"/></a><a class="box-device" href="#"><img src="<?php echo e(asset('frontend/images/index-4-313x580.png')); ?>" alt="" width="313" height="580"/></a><a class="box-device" href="#"><img src="<?php echo e(asset('frontend/images/index-5-313x580.png')); ?>" alt="" width="313" height="580"/></a></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container-fluid">
    ...
    <div class="row row-50 row-sm">
      <div class="col-md-6 col-xl-4 wow fadeInRight">
        ...
        <article class="quote-modern quote-modern-custom">
          <div class="unit unit-spacing-md align-items-center">
            <div class="unit-left"><a class="quote-modern-figure" href="#"><img class="img-circles" src="<?php echo e(asset('frontend/images/user-11-75x75.jpg')); ?>" alt="" width="75" height="75"/></a></div>
            <div class="unit-body">
      ...
      <div class="col-md-6 col-xl-4 wow fadeInRight" data-wow-delay=".1s">
        ...
        <article class="quote-modern quote-modern-custom">
          <div class="unit unit-spacing-md align-items-center">
            <div class="unit-left"><a class="quote-modern-figure" href="#"><img class="img-circles" src="<?php echo e(asset('frontend/images/user-12-75x75.jpg')); ?>" alt="" width="75" height="75"/></a></div>
            <div class="unit-body">
      ...
      <div class="col-md-6 col-xl-4 wow fadeInRight" data-wow-delay=".2s">
        ...
        <article class="quote-modern quote-modern-custom">
          <div class="unit unit-spacing-md align-items-center">
            <div class="unit-left"><a class="quote-modern-figure" href="#"><img class="img-circles" src="<?php echo e(asset('frontend/images/user-20-75x75.jpg')); ?>" alt="" width="75" height="75"/></a></div>
            <div class="unit-body">
  ...
  <div class="container">
    ...
    <div class="row row-45">
      <div class="col-sm-6 col-lg-4 wow fadeInLeft">
        <!-- Post Modern-->
        <article class="post post-modern"><a class="post-modern-figure" href="#"><img src="<?php echo e(asset('frontend/images/post-10-370x307.jpg')); ?>" alt="" width="370" height="307"/>
      ...
      <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".1s">
        <!-- Post Modern-->
        <article class="post post-modern"><a class="post-modern-figure" href="#"><img src="<?php echo e(asset('frontend/images/post-11-370x307.jpg')); ?>" alt="" width="370" height="307"/>
            <div class="post-modern-time">
      ...
      <div class="col-sm-6 col-lg-4 wow fadeInLeft" data-wow-delay=".2s">
        <!-- Post Modern-->
        <article class="post post-modern"><a class="post-modern-figure" href="#"><img src="<?php echo e(asset('frontend/images/post-12-370x307.jpg')); ?>" alt="" width="370" height="307"/>
            <div class="post-modern-time">
      ...
      <div class="col-sm-8 col-md-6 col-lg-4">
        <article class="box-contacts">
          <div class="box-contacts-body">
            ...
            <p class="box-contacts-link"><a href="tel:#">+237 696150429</a></p>
      ...
      <div class="col-sm-8 col-md-6 col-lg-4">
        <article class="box-contacts">
          <div class="box-contacts-body">
            ...
            <div class="box-contacts-decor"></div>
            <p class="box-contacts-link"><a href="#">Face Ecole de Police, près de la banque UBA, Yaoundé, Cameroun</a></p>
          </div>
        </article>
      </div>
      <div class="col-sm-8 col-md-6 col-lg-4">
        <article class="box-contacts">
          <div class="box-contacts-body">
            ...
            <div class="box-contacts-decor"></div>
            <p class="box-contacts-link"><a href="mailto:#">Calexoptic@yahoo.fr</a></p>
            <p class="box-contacts-link"><a href="mailto:#">Calexoptique237@gmail.com</a></p>
          </div>
        </article>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\line\Calex_op\Calex-optique\resources\views/index.blade.php ENDPATH**/ ?>