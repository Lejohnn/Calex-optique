<?php $__env->startSection('title', 'Ajouter une Interaction de Service Call'); ?>
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">Ajouter une Interaction de Service Call pour <?php echo e($client->nom); ?> <?php echo e($client->prenom); ?></h3>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('call.entreprise.store', $client->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\line\Calex_op\Calex-optique\resources\views/call/entreprise/create.blade.php ENDPATH**/ ?>