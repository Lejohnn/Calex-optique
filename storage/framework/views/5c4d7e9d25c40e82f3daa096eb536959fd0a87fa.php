<?php $__env->startSection('title', 'Liste des Ordonnances'); ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <a href="<?php echo e(route('ordonnance.create')); ?>" class="btn btn-primary  ">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($prescription->nom_patient); ?></td>
                                                    <td><?php echo e($prescription->age); ?></td>
                                                    <td><?php echo e($prescription->date->format('d-m-Y')); ?></td>
                                                    <td>
                                                        <a href="<?php echo e(route('prescriptions.show', $prescription->id)); ?>"><i class="ft-eye text-info"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\line\Calex_op\Calex-optique\resources\views/clients/listeOrdonnance.blade.php ENDPATH**/ ?>