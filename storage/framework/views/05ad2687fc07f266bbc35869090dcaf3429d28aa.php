...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/vendors/css/forms/icheck/icheck.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/vendors/css/forms/icheck/custom.css')); ?>">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('backend/css/pages/login-register.css')); ?>">
    <!-- END: Page CSS-->
...
<!-- end content -->
<?php /**PATH D:\line\Calex_op\Calex-optique\resources\views/layouts/connect.blade.php ENDPATH**/ ?>