    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item" id="client">
                    <a href="#">
                        ...
                        <span class="menu-title" data-i18n="Invoice">Gestion des
                            @if (auth()->user()->role_id == 3 or auth()->user()->role_id == 4 or auth()->user()->role_id == 10)
                                Patients
                            @endif
                            @if (auth()->user()->role_id != 3 and auth()->user()->role_id != 4 and auth()->user()->role_id != 10)
                                Clients
                            @endif
                        </span>
                    </a>
                    <ul class="menu-content">
                        @if (auth()->user()->role_id == 2 or auth()->user()->role_id == 1 or auth()->user()->role_id == 8)
                        ...
                        @if (auth()->user()->role_id == 4 or auth()->user()->role_id == 1)
                            <li class="{{ Request::is('clients/factures') ? 'active' : '' }}">
                                <a class="menu-item" href="{{ route('caisse.recu.index') }}">
                                    <i></i>
                ...
                <li class="nav-item" id="admin">
                    ...
                    <ul class="menu-content">
                        @if (auth()->user()->role_id == 1 or
                                ...
                                auth()->user()->role_id == 8 or
                                auth()->user()->role_id == 10)
                            <li class="{{ Request::is('commercial') ? 'active' : '' }}">
                                <a class="menu-item" href="{{ route('commercial.index') }}">
                                    <i></i>
                        ...
                        @if (auth()->user()->role_id == 1 or auth()->user()->role_id == 8)
                            ...
                            <li class="{{ Request::is('commercialstat') ? 'active' : '' }}">
                                <a class="menu-item" href="{{ route('commercial.stats') }}">
                                    <i></i>
                                    <span data-i18n="Invoice Summary">Statistiques</span>
                                </a>
                            </li>
                            {{-- <li class="{{ Request::is('commercialstat') ? 'active' : '' }}">
                    <a class="menu-item" href="{{ route('commercials.monthlyPerformance') }}">
                        <i></i>
                        <span data-i18n="Invoice Summary">Performance du Mois</span>
                    </a>
                </li> --}}
                        @endif
                        @if (auth()->user()->role_id == 1 or auth()->user()->role_id == 6 or auth()->user()->role_id == 8)
                            <li class="{{ Request::is('commercial/create') ? 'active' : '' }}">
                                <a class="menu-item" href="{{ route('commercial.create') }}">
                                    <i></i>
            ...
            <li class="nav-item" id="admin">
                ...
                <ul class="menu-content">
                    <li class="{{ Request::is('clients_call') ? 'active' : '' }}">
                        <a class="menu-item" href="{{ route('call_service.showClients') }}">
                            <i></i>
                            <span data-i18n="Invoice Summary">Clients Entreprise</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('prospects') ? 'active' : '' }}">
                        <a class="menu-item" href="{{ route('call_service.prospects') }}">
                            <i></i>
                            <span data-i18n="Invoice Summary">Clients Prospectés</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            @if (auth()->user()->role_id == 1 or auth()->user()->role_id == 5)
                <li class="nav-item" id="admin">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ Request::is('caisse/facture') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('caisse.facture') }}">
                                <i></i>
                                <span data-i18n="Invoice Summary">Générer une facture</span>
                            </a>
                        </li>
                        <li class="{{ Request::is('factures') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('caisse.views') }}">
                                <i></i>
                                <span data-i18n="Invoice Summary">Visualiser les factures</span>
                            </a>
                        </li>
                        {{-- <li class="{{ Request::is('montures') ? 'active' : '' }}">
                        <a class="menu-item" href="{{ route('caisse.montures.index') }}">
                            <i></i>
                            <span data-i18n="Invoice Summary">Visualiser les factures</span>
                        </a>
                    </li> --}}
            ...
            @if (auth()->user()->role_id == 1 or auth()->user()->role_id == 4)
                <li class="nav-item" id="admin">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="{{ Request::is('get-codes') ? 'active' : '' }}">
                            <a class="menu-item" href="{{ route('frames.index') }}">
                                <i></i>
            ...
            <li class="nav-item" id="admin">
                ...
                <ul class="menu-content">
                    <li class="{{ Request::is('notifications') ? 'active' : '' }}">
                        <a class="menu-item" href="{{ route('notifications.index') }}">
                            <i></i>
