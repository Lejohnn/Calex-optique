                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                            ...
                            <span class="badge badge-pill {{ $notifications_notread == 0 ? '' : 'badge-danger' }} badge-up badge-glow">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge {{ $notifications_notread == 0 ? '' : 'badge-danger' }} float-right m-0">{{ $notifications_notread }} New</span>
                            </li>
                            @foreach($notifications as $notification)
                            <li class="scrollable-container media-list w-100 {{ $notification->status == 0 ? 'bg-light text-dark' : '' }}">
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="notification-text font-small-3 text-muted font-weight-bold">{{ $notification->message }}</p>
                                            <small>
                                                <time class="media-meta text-success font-weight-bold" datetime="{{ $notification->created_at }}">{{ Carbon\Carbon::parse($notification->created_at)->locale('fr')->format('l') }} le {{ $notification->created_at }}</time>
                                            </small>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                <img src="{{ asset('backend/images/portrait/small/avat.png') }}" alt="avatar">
                                <i></i>
                            </span>
                        </a>
