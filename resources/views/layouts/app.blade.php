        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item" id="admin">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ Request::is('users') ? 'active' : '' }}"><a class="menu-item" href="{{ route('users.index') }}"><i></i><span data-i18n="Invoice Template">Lister les utilisateurs</span></a>
            ...
            @endif
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ Request::is('commercialstat') ? 'active' : '' }}"><a class="menu-item" href="{{ route('commercial.stat') }}"><i></i><span data-i18n="Invoice Summary">Statistiques</span></a></li>
                </ul>
                </li>
                    @endif
